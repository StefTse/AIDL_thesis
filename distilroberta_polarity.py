# -*- coding: utf-8 -*-
"""distilroBERTa_polarity.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1U000-hMg-m_-4j-rTLDdvzOmB-VMfveC
"""
...
tokenizer = AutoTokenizer.from_pretrained("sberryman/twitter-roberta-base-sentiment-fork-latest")
# max_length=170
...
model_roberta =AutoModelForSequenceClassification.from_pretrained("cardiffnlp/twitter-roberta-base-hate-multiclass-latest")
...
history = model_roberta.train(x_train_array, y_train_enc, batch_size=64, epochs=5,
